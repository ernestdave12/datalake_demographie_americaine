...
insert("occupation")
insert("poverty")
create_and_insert_table_ages.import_ages_in_sql(2021)
create_and_insert_table_ages.import_ages_in_sql(2022)
create_and_insert_table_ages.import_ages_in_sql(2023)
